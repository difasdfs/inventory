...
isi += "GNM10020201;Tisu (Livi Luncheon 100's);Pack;" + str(tisu_livi_luncheon_100s_GNM10020201).replace('.',',') + '\n'
isi += 'MLP10070201;Kresek 24 Putih (Tristar);Pack;' + str(kresek_24_putih_tristar_MLP10070201).replace('.',',') + '\n'
isi += 'RJC10010101;Bawang Putih Biasa;Gram;' + str(bawang_putih_biasa_RJC10010101).replace('.',',') + '\n'
...
isi += 'MLP10130101;Cup Pudding;Pcs;' + str(cup_puding_MLP10130101).replace('.',',') + '\n'
print(isi)
